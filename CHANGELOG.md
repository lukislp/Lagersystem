...
- Updated all Microsoft NuGet packages to 10.x
- Cleaned up repository structure (removed legacy SQL migration scripts, PowerShell helpers, and stale documentation)
